...
if (isset($_SESSION['confirmar'])) {
    ...
    if (isset($_SESSION['nombre']) && isset($_SESSION['apellidos']) && isset($_SESSION['provincia']) && isset($_SESSION['correo']) && isset($_SESSION['password'])) {
        $query = "INSERT INTO usuarios (nombre, apellidos, provincia, email, contraseña, tipo) VALUES ('$_SESSION[nombre]','$_SESSION[apellidos]','$_SESSION[correo]','$_SESSION[password]',2)";

...
if ($num_filas == 0) {
    ...
    echo "<div>
    <div class='content'>
    <div  class='table-responsive pp tabla' id='eventos'>
...
echo "<div style='display:flex; align-items:center; justify-content:center'>
    <h5 class='tituloUsuarios' style='font-weight: bold; margin-top: 20px'>Festivales</h5>
</div>";
...
{
    mysqli_query($con, "UPDATE eventos SET nombre_evento='$evento_nombre', ubicacion='$ubicacion', fecha_inicio='$f_inicio', fecha_fin='$f_fin', precio='$precio', web_evento='$web', imagen_evento='$imagen', info_evento='$info' WHERE id_evento=$id_evento");
}
